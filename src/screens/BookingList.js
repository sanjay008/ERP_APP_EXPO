  ...
  return (
    <View style={styles.container}>
      ...
      <BlueHeader
        ...
        title={itemData?.item_title ? t(`${itemData?.item_title}`) : t("Booking List")}
      ...
      >
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          {String(AllPermission?.taxi_booking_view?.create) === "1" && (
            <TouchableOpacity style={styles.AddBtn} onPress={() => setstep(1)}>
              <Text style={styles.Text}>{t("+Add")}</Text>
            </TouchableOpacity>
          )}
          {/* <TouchableOpacity style={[styles.AddBtn]} onPress={() => setstep(1)}>
            <Text style={styles.Text}>{t("Past Booking")}</Text>
          </TouchableOpacity> */}
        </View>
